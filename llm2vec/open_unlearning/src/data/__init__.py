...
from data.wikitext_retain import WikiTextRetainDataset
#from data.pmc_qa import PMCQADataset
from data.pmc import PMCFinetuneDataset
from data.hybrid import HybridQADataset
...
_register_data(CelebrityUnlearnDataset)
_register_data(WikiTextRetainDataset)
#_register_data(PMCQADataset)
# Register composite datasets used in unlearning
# groups: unlearn
_register_data(ForgetRetainDataset)
_register_data(PMCFinetuneDataset)
_register_data(HybridQADataset)
# Register collators
