...
CUDA_LAUNCH_BLOCKING=1 HYDRA_FULL_ERROR=1 python src/train.py --config-name=unlearn.yaml experiment=unlearn/celebrity_death_npo/default_llama2 task_name=celebrity_npo_death_llama2
