...
class UnlearningDataset(Dataset):
    def __init__(self, args, retain_csv_path, forget_csv_path, batch_size):
        ...
        control_vector = control_vector.view(1, args.hidden_size).to(dtype=torch.bfloat16)
...
def l_con_retain(retain_embs, forget_embs, n_augment, temp=0.1):
    ...
    print("l_con_retain")
    print("retain_embs")
    print(retain_embs.shape)
   # print(retain_embs)
    print("forget_embs")
    print(forget_embs.shape)
   # print(forget_embs)
...
def main():
    ...
    train_dataset = UnlearningDataset(custom_args, data_args.retain_csv_path, data_args.forget_csv_path, training_args.per_device_train_batch_size)
