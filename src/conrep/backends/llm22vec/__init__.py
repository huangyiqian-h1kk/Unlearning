...
package search path falls back to the pinned upstream ``llm2vec`` package for
support modules that were byte-identical before Phase 3D-R.
"""

from pathlib import Path as _Path


_CANONICAL_PACKAGE = str(_Path(__file__).resolve().parents[4] / "third_party" / "llm2vec" / "llm2vec")
